...
# 判断一组URL是否含有相应的URL资源；页面中含有"404 Not Found"或者"Error 404"说明资源不存在

import urllib
import urlparse
import HTMLParser

class CheckHTML(HTMLParser.HTMLParser):  # 从HTMLParser类继承
    available = True
...
for url in check_urls:
    new_url = urlparse.urljoin("https://www.python.org/",url)   # 拼合URL
